  ...
  <body>
    <div id="wrapper">
      <header>
        ...
        <div class="logo">
          <div>
            <a href="/Kmarket/cs/index.jsp"><img src="./img/logo.png" alt="로고" />고객센터</a>
          </div>
        </div>
      </header>
      ...
      <section id="cs">
        <div class="main">
          ...
          <section class="notice">
            <h1>공지사항<a href="./qna/list.html">전체보기</a></h1>
            <ul>
              <li>
                <a href="/Kmarket/cs/notice/view.html" class="title">[안내] 해외결제 사칭 문자 주의</a>
          ...
          <section class="faq">
            ...
            <ol>
              <li>
                <a href="/Kmarket/cs/qna/list.html"><span>회원</span></a>
              </li>
              <li>
          ...
          <section class="qna">
            <h1>문의하기<a href="./qna/list.html">전체보기</a></h1>
            <ul>
              <li>
                <a href="/Kmarket/cs/faq/view.html" class="title">[회원] 개인회원과 법인회원에 차이가 있나요?</a>
                <p>
            ...
            <a href="/Kmarket/cs/qna/write.html" class="ask">문의글 작성 ></a>
          </section>
