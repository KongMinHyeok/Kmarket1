        ...
        <div class="notice">
          ...
          <section class="list">
            <aside>
              <h2>공지사항</h2>
              <ul>
                <li class="on"><a href="/Kmarket/cs/notice/list.html">전체</a></li>
            ...
            <article>
              ...
              <table>
                <tr>
                  <td><a href="/Kmarket/cs/notice/view.html">[안내] 해외결제 사칭 문자 주의</a></td>
                  <td>2022.11.21</td>
                </tr>
                <tr>
                  <td><a href="#">[발표]『G.Live X SK스토아(하남쭈꾸미)』 이벤트 당첨자</a></td>
                  <td>2022.11.21</td>
                </tr>
                <tr>
