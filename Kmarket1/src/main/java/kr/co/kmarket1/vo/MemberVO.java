...
public class MemberVO {
	...
	public String getSessDateLimit() {
		return sessDateLimit;
	}
	public void setSessDateLimit(String sessDateLimit) {
		this.sessDateLimit = sessDateLimit;
	}
